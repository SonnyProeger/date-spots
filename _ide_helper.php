...
')
    ...
    namespace Illuminate\Support {use ArrayAccess;
            /**
     * 
     *
     */ 
     ...
     */ 
        ...
        namespace Barryvdh\Debugbar\Facades {use Barryvdh\Debugbar\JavascriptRenderer;use Barryvdh\Debugbar\LaravelDebugbar;use Closure;use DebugBar\array;use DebugBar\DataCollector\DataCollectorInterface;use DebugBar\HttpDriverInterface;use DebugBar\RequestIdGeneratorInterface;use DebugBar\StorageInterface;use ErrorException;use Exception;use Symfony\Component\HttpFoundation\Request;use Symfony\Component\HttpFoundation\Response;use Throwable;
            /**
     * 
     *
    ...
    namespace Illuminate\Testing {use Closure;use Illuminate\Http\Response;
            /**
     * 
     *
     * @mixin Response
