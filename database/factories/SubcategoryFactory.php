...
class SubcategoryFactory extends Factory
{
    ...
    public function definition(): array
    {
        $specificSubcategoriesByCategory = [
            ...
            'beach' => ['Beach picnic', 'Water sports'],
            'waterfront' => ['Waterfront dining', 'Boat ride'],
            'hiking' => ['Scenic trails', 'Mountain hiking'],
            'adventure' => ['Zip-lining', 'Adventure parks'],
            'botanical garden' => ['Botanical tour', 'Plant observation'],
            'picnic' => ['Picnic in the park', 'Scenic spots'],
            'movie theater' => ['Blockbuster movies', 'Indie films'],
